...
public class CircleProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        if(showText) {
            topText = attributes.getString(R.styleable.CircleProgress_top_text);
            topTextColor = attributes.getColor(R.styleable.CircleProgress_top_text_color, defaultTopTextColor);
            topTextSize = attributes.getDimension(R.styleable.CircleProgress_top_text_size, defaultTopTextSize);

            midSubText = attributes.getString(R.styleable.CircleProgress_mid_sub_text);
            midSubTextColor = attributes.getColor(R.styleable.CircleProgress_mid_sub_text_color, defaultMidSubTextColor);
            midSubTextSize = attributes.getDimension(R.styleable.CircleProgress_mid_sub_text_size, defaultMidSubTextSize);

            midText = attributes.getString(R.styleable.CircleProgress_mid_text);
            midTextColor = attributes.getColor(R.styleable.CircleProgress_mid_text_color, defaultMidTextColor);
            midTextSize = attributes.getDimension(R.styleable.CircleProgress_mid_text_size, defaultMidTextSize);

            bottom1Text = attributes.getString(R.styleable.CircleProgress_bottom1_text);
            bottom1TextColor = attributes.getColor(R.styleable.CircleProgress_bottom1_text_color, defaultBottom1TextColor);
            bottom1TextSize = attributes.getDimension(R.styleable.CircleProgress_bottom1_text_size, defaultBottom1TextSize);

            bottom2Text = attributes.getString(R.styleable.CircleProgress_bottom2_text);
            bottom2TextColor = attributes.getColor(R.styleable.CircleProgress_bottom2_text_color, defaultBottom2TextColor);
            bottom2TextSize = attributes.getDimension(R.styleable.CircleProgress_bottom2_text_size, defaultBottom2TextSize);
        }
        finishedStrokeWidth = attributes.getDimension(R.styleable.CircleProgress_finished_stroke_width, defaultStrokeWidth);
        unfinishedStrokeWidth = attributes.getDimension(R.styleable.CircleProgress_unfinished_stroke_width, defaultStrokeWidth);
        finishedColor = attributes.getColor(R.styleable.CircleProgress_finished_color, defaultFinishedColor);
        unfinishedColor = attributes.getColor(R.styleable.CircleProgress_unfinished_color, defaultUnfinishedColor);
